				...
				<tbody>
					@foreach($models as $bank)
						<tr data-id="{{$bank->bank_id}}">
							...
							<td>
								<i class="fa fa-trash modal-trigger" data-action="delete.bank" data-target="delete-modal"></i>
			              		<i class="fa fa-pencil modal-trigger" data-action="update.bank" data-target="edit-modal"></i>
							</td>
						</tr>
					@endforeach
				</tbody>
...
<div id="edit-modal" class="modal">
         ...
         <fieldset>
         	<div class="row">
			    <div class="col s12">
			        ...
			        <input type="text" name="name" class="validate name" id="bank-name" required>
			    </div>
	        </div>
	        <div class="row">
    ...
    <div class="modal-footer">
      <button type="submit" class="modal-action waves-effect waves-green btn-flat done-btn" data-action="add.bank">Done</button>
